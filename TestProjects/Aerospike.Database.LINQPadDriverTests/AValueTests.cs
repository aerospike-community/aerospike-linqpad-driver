...
[
  ...
  },
  {
    ...
    ""BinC"": ""5/9/2023 2:42:40 PM""
		...
		{
			var aValue = new object[] { "element0",
			...
			Assert.IsTrue(aValue.ElementAtOrDefault(1)
										.TryGetValue("properties", true)
										.ElementAtOrDefault(0)
										.TryGetValue("itemCat", true) == 1234);

			Assert.IsFalse(aValue.ElementAtOrDefault(0)
										.TryGetValue("properties", true)
										.ElementAtOrDefault(0)
										.TryGetValue("itemCat", true) == 1234);
			...
			Assert.IsTrue(aValue.ElementAtOrDefault(1)
										.TryGetValue("properties", true)
										.ElementAtOrDefault(0)
										.TryGetValue("values", true)
										.ElementAtOrDefault(1)
										.TryGetValue("ordDt", true) == "2024-05-15");
