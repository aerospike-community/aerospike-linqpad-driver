...
namespace Aerospike.Database.LINQPadDriver
{
    public sealed partial class LPUDF
    {
        ...
        public static LPUDF[]  Create(Connection connection, LPModule module)
        {
            ...
            if(string.IsNullOrEmpty(udfget) || udfget == "error=invalid_filename") return Array.Empty<LPUDF>();
            ...
            */
            ...
            while (currentCodeBlock != null)
            {
                ...
                {
                    udfList.Add(new LPUDF(module, currentCodeBlock));
