...
Executed for the Formatted Version of the README.md file in this folder, which should provide an overview of these samples and how to use them.
*/

var sampleFolder = Path.GetDirectoryName(Util.CurrentQueryPath);
var readmePath = Path.Combine(sampleFolder, "README.md");

if (!File.Exists(readmePath))
{
    $"README not found: {readmePath}".Dump();
    return;
}

var markdown = File.ReadAllText(readmePath);

Util.Markdown(markdown).Dump("AI Samples README");