...
LINQPad API documentation can be found in the [Help Folder](https://aerospike-community.github.io/aerospike-linqpad-driver/).
...
-   <https://github.com/aerospike-community/aerospike-linqpad-driver/blob/main/docs/help>
